...
python early:
    simple_achievement_list = (
        ...
        ("Tutorialist","\n{image=01.tutorialist.png}    \nComplete the tutorial    Status: Not Completed\n\n", "\n{image=01.tutorialist.png}    \nComplete the tutorial    Status: Completed\n\n"),
        ("A New Leaf", "\n{image=02.aNewLeaf.png}    \nStarted a new game    Status: Not Completed\n\n", "\n{image=02.aNewLeaf.png}    \nStarted a new game    Status: Completed\n\n"),
        ("I Love Mom's Breakfast", "\n{image=03.iLoveMomBreakfast.png}    \nEat all foods in breakfast    Status: Not Completed\n\n", "\n{image=03.iLoveMomBreakfast.png}    \nEat all foods in breakfast    Status: Completed\n\n"),
        ("Newspaper Guy", "\n{image=04.newspaperGuy.png}    \nRead newspaper    Status: Not Completed\n\n", "\n{image=04.newspaperGuy.png}    \nRead newspaper    Status: Completed\n\n"),
        ("TV Guy", "\n{image=05.tvGuy.png}    \nWatch the TV    Status: Not Completed\n\n", "\n{image=05.tvGuy.png}    \nWatch the TV    Status: Completed\n\n"),
        ("Beep Card","\n{image=06.beepCard.png}    \nRide the train    Status: Not Completed\n\n", "\n{image=06.beepCard.png}    \nRide the train    Status: Completed\n\n"),
        ("Bayad Po","\n{image=07.bayadPo.png}    \nRide the jeep    Status: Not Completed\n\n", "\n{image=07.bayadPo.png}    \nRide the jeep    Status: Completed\n\n"),
        ("Ace Attorney","\n{image=08.aceAttorney.png}    \nPerfectly answer all questions when asked by friend about Safe Spaces Act    Status: Not Completed\n\n", "\n{image=08.aceAttorney.png}    \nPerfectly answer all questions when asked by friend about Safe Spaces Act    Status: Completed\n\n"),
        ("Escape Artist","\n{image=09.escapeArtist.png}    \nRun away from the stalker    Status: Not Completed\n\n", "\n{image=09.escapeArtist.png}    \nRun away from the stalker    Status: Completed\n\n"),
        ("Punching Bag","\n{image=10.punchingBag.png}    \nPick a fight    Status: Not Completed\n\n", "\n{image=10.punchingBag.png}    \nPick a fight    Status: Completed\n\n"),
        ("Teach Me About Punishments","\n{image=11.teachMeAboutPunishment.png}    \nListen to Officer Greg's long speech    Status: Not Completed\n\n", "\n{image=11.teachMeAboutPunishment.png}    \nListen to Officer Greg's long speech    Status: Completed\n\n"),
        ("Bad End","\n{image=12.badEnd.png}    \nAchieve a bad ending    Status: Not Completed\n\n", "\n{image=12.badEnd.png}    \nAchieve a bad ending    Status: Completed\n\n"),
        ("Good End","\n{image=12.goodEnd.png}    \nAchieve a good ending    Status: Not Completed\n\n", "\n{image=12.goodEnd.png}    \nAchieve a good ending    Status: Completed\n\n"),
        ("Special End","\n{image=13.specialEnd.png}    \nAchieve a special ending    Status: Not Completed\n\n", "\n{image=13.specialEnd.png}    \nAchieve a special ending    Status: Completed\n\n"),
        ("Lunch Date","\n{image=14.lunchDate.png}    \nGet invited to lunch    Status: Not Completed\n\n", "\n{image=14.lunchDate.png}    \nGet invited to lunch    Status: Completed\n\n"),
        ("Big Eater","\n{image=15.bigEater.png}    \nEat everything in school cafeteria    Status: Not Completed\n\n", "\n{image=15.bigEater.png}    \nEat everything in school cafeteria    Status: Completed\n\n"),
        ("Galaxy Brain","\n{image=16.galaxyBrain.png}    \nAchieve a perfect score in quiz    Status: Not Completed\n\n", "\n{image=16.galaxyBrain.png}    \nAchieve a perfect score in quiz    Status: Completed\n\n"),
        ("Lending A Helping Hand","\n{image=17.helpingHand.png}    \nHelp get the pervert teacher arrested    Status: Not Completed\n\n", "\n{image=17.helpingHand.png}    \nHelp get the pervert teacher arrested    Status: Completed\n\n"),
